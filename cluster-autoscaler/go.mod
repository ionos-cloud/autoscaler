...
replace (
	...
	k8s.io/api => /tmp/autoscaler/kubernetes/staging/src/k8s.io/api
	k8s.io/apiextensions-apiserver => /tmp/autoscaler/kubernetes/staging/src/k8s.io/apiextensions-apiserver
	k8s.io/apimachinery => /tmp/autoscaler/kubernetes/staging/src/k8s.io/apimachinery
	k8s.io/apiserver => /tmp/autoscaler/kubernetes/staging/src/k8s.io/apiserver
	k8s.io/cli-runtime => /tmp/autoscaler/kubernetes/staging/src/k8s.io/cli-runtime
	k8s.io/client-go => /tmp/autoscaler/kubernetes/staging/src/k8s.io/client-go
	k8s.io/cloud-provider => /tmp/autoscaler/kubernetes/staging/src/k8s.io/cloud-provider
	k8s.io/cluster-bootstrap => /tmp/autoscaler/kubernetes/staging/src/k8s.io/cluster-bootstrap
	k8s.io/code-generator => /tmp/autoscaler/kubernetes/staging/src/k8s.io/code-generator
	k8s.io/component-base => /tmp/autoscaler/kubernetes/staging/src/k8s.io/component-base
	k8s.io/cri-api => /tmp/autoscaler/kubernetes/staging/src/k8s.io/cri-api
	k8s.io/csi-translation-lib => /tmp/autoscaler/kubernetes/staging/src/k8s.io/csi-translation-lib
	k8s.io/gengo => k8s.io/gengo v0.0.0-20200205140755-e0e292d8aa12
	k8s.io/heapster => k8s.io/heapster v1.2.0-beta.1
	k8s.io/klog => k8s.io/klog v1.0.0
	k8s.io/kube-aggregator => /tmp/autoscaler/kubernetes/staging/src/k8s.io/kube-aggregator
	k8s.io/kube-controller-manager => /tmp/autoscaler/kubernetes/staging/src/k8s.io/kube-controller-manager
	k8s.io/kube-openapi => k8s.io/kube-openapi v0.0.0-20200403204345-e1beb1bd0f35
	k8s.io/kube-proxy => /tmp/autoscaler/kubernetes/staging/src/k8s.io/kube-proxy
	k8s.io/kube-scheduler => /tmp/autoscaler/kubernetes/staging/src/k8s.io/kube-scheduler
	k8s.io/kubectl => /tmp/autoscaler/kubernetes/staging/src/k8s.io/kubectl
	k8s.io/kubelet => /tmp/autoscaler/kubernetes/staging/src/k8s.io/kubelet
	k8s.io/legacy-cloud-providers => /tmp/autoscaler/kubernetes/staging/src/k8s.io/legacy-cloud-providers
	k8s.io/metrics => /tmp/autoscaler/kubernetes/staging/src/k8s.io/metrics
	k8s.io/sample-apiserver => /tmp/autoscaler/kubernetes/staging/src/k8s.io/sample-apiserver
	k8s.io/sample-cli-plugin => /tmp/autoscaler/kubernetes/staging/src/k8s.io/sample-cli-plugin
	k8s.io/sample-controller => /tmp/autoscaler/kubernetes/staging/src/k8s.io/sample-controller
