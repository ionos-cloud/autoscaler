...
type mockConstructorTestingTNewMockIonosCloudManager interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockIonosCloudManager(t mockConstructorTestingTNewMockIonosCloudManager) *MockIonosCloudManager {
